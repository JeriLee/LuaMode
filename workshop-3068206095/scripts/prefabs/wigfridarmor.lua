local assets =
{
	...
	Asset("ATLAS", "images/inventoryimages/wigfridarmor.xml"), --加载物品栏贴图
    Asset("IMAGE", "images/inventoryimages/wigfridarmor.tex"),
}
...
local function fn()
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/wigfridarmor.xml"  --加载物品栏贴图 mod物品必须有
    ...
    inst.components.armor:InitCondition(525,0.8) --耐久度和减伤（80%）
...
return Prefab("wigfridarmor", fn, assets) --生成这个预设物  代码为 wigfridarmor
